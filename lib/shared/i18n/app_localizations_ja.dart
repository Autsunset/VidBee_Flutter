class AppLocalizationsJa {
  final Map<String, String> _localizedValues = {
    ...
    'downloadPackage': 'インストールパッケージ',
    'downloadAndInstall': 'ダウンロードしてインストール',
    'installPackageReady': 'パッケージをダウンロードしました。システムインストーラーを開きます',
    'installPermissionRequired': 'インストール権限が必要です',
    'installPermissionMessage':
        'VidBee に不明なアプリのインストールを許可してから、戻ってもう一度ダウンロードしてインストールをタップしてください。',
    'noCompatibleApk': 'この端末に対応するAPKが見つかりません',
    ...
    'retryQueued': 'ダウンロードキューに再追加しました',
    'fileUnavailable': 'ファイルを利用できません。移動または削除された可能性があります。',
    'errorDetails': 'エラー詳細',
    'cookieImportedSummary': '{count} サイトのCookieをインポートしました',
    'clearCookieConfirm': '{domain} のCookieを削除しますか？再ログインが必要になります。',
    'cookieCleared': '{domain} のCookieを削除しました',
    'selectCookieFile': 'cookies.txtファイルを選択',
    'selectDownloadDirectory': 'ダウンロード先フォルダを選択',
    'downloadPathSaved': 'ダウンロード先を設定しました: {path}',
    'selectPathFailed': 'パスの選択に失敗しました: {error}',
    'updateYtDlpSuccess': 'yt-dlpを更新しました。',
