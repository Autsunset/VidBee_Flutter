class AppLocalizationsZh {
  final Map<String, String> _localizedValues = {
    ...
    'installPackageReady': '安装包已下载，正在打开系统安装器',
    'installPermissionRequired': '需要安装权限',
    'installPermissionMessage': '请允许 VidBee 安装未知来源应用，然后返回重新点击下载并安装。',
    'noCompatibleApk': '未找到适配当前设备的安装包',
    ...
    'retryQueued': '已重新加入下载队列',
    'fileUnavailable': '文件不可用，可能已被移动或删除',
    'errorDetails': '错误详情',
    'cookieImportedSummary': '已导入 {count} 个网站的 Cookie',
    'clearCookieConfirm': '确定要清理 {domain} 的 Cookie 吗？清理后需要重新登录。',
    'cookieCleared': '{domain} Cookie 已清理',
    'selectCookieFile': '选择 cookies.txt 文件',
    'selectDownloadDirectory': '选择下载目录',
    'downloadPathSaved': '下载路径已设置为：{path}',
    'selectPathFailed': '选择路径失败：{error}',
    'updateYtDlpSuccess': 'yt-dlp 更新成功！',
